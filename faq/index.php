        ...
        <div class="container">
            ...
            ?>
                <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                    <ul class="nav navbar-nav">
                        <li>
                            <a href="/Online-Car-Rental/index.php">Home</a>
                        </li>
                        <li>
                            <a href="/Online-Car-Rental/clientlogin.php"><span class="glyphicon glyphicon-user"></span> Welcome <?php echo $_SESSION['login_client']; ?></a>
                        </li>
                        <li>
                            <ul class="nav navbar-nav navbar-right">
                                <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> Control Panel <span class="caret"></span> </a>
                                    <ul class="dropdown-menu">
                                        <li> <a href="/Online-Car-Rental/entercar.php">Add Car</a></li>
                                        <li> <a href="/Online-Car-Rental/enterdriver.php"> Add Driver</a></li>
                                        <li> <a href="/Online-Car-Rental/clientview.php">View</a></li>
                        ...
                        <li>
                            <a href="/Online-Car-Rental/logout.php"><span class="glyphicon glyphicon-log-out"></span> Logout</a>
                        </li>
                    </ul>
                </div>
            ...
            ?>
                    <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <a href="/Online-Car-Rental/customerlogin.php"><span class="glyphicon glyphicon-user"></span> Welcome <?php echo $_SESSION['login_customer']; ?></a>
                            </li>
                            <ul class="nav navbar-nav">
                                <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Car Bookings <span class="caret"></span> </a>
                                    <ul class="dropdown-menu">
                                        <li> <a href="/Online-Car-Rental/bookcar.php">Book Car</a></li>
                                        <li> <a href="/Online-Car-Rental/prereturncar.php">Return Now</a></li>
                                        <li> <a href="/Online-Car-Rental/mybookings.php"> Previous Bookings</a></li>
                                    </ul>
                                </li>
                            </ul>
                            <li>
            ...
            ?>
                        ...
                        <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                            <ul class="nav navbar-nav">
                                <li>
                                    <a href="/Online-Car-Rental/index.php"><i class="fa fa-home"></i> Home</a>
                                </li>
                                <li>
                                    <a href="/Online-Car-Rental/clientlogin.php"><i class="fa fa-users"></i> Client</a>
                                </li>
                                <li>
                                    <a href="/Online-Car-Rental/customerlogin.php"><i class="fa fa-user"></i> Customer</a>
                                </li>
                                <li>
                                    <a href="/Online-Car-Rental/faq/index.php"style="text-decoration: underline"><i class="fa fa-question-circle"></i> FAQ </a>
                                </li>
                            </ul>
                        </div>
                        <?php   }
 ...
 <div class="w3-content w3-container w3-padding-64" id="contact">
        ...
        <div class="w3-row w3-padding-32 w3-section">
            <div class="w3-col w3-panel">
                ...
                <form action="/Online-Car-Rental/action_page.php?type=question" method="POST">
...
<footer class="site-footer">
        <div class="w3-container">
            ...
            <div class="row">
                ...
                <div class="col-sm-6" >
                  <h5 style="text-align: right;">Developed by: <span style="color:#000000; font-weight:500;">Muhammad Farhan</span></h5>
                </div>
            </div>
        </div>
</footer>
